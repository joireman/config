...
######################################################
# Set PATH so it inclues user's private bin if it exists
#
if [ -d "${HOME}/bin" ] ; then
#  export PATH="/opt/miniconda/bin:${HOME}/bin:${PATH}" 
...
export PHYSIQ_REST_ACCESS_KEY=8075F197FBA22BC629EE5702BB908EACA998B4DA
export PHYSIQ_REST_SECRET_KEY=855AA876BBAF4B926912C2C9EB0136A9AAA337B1

######################################################
# CDPATH
# Colon separated list of directories to search when issuing cd command  
CDPATH=:$VGBIO_SRC_DIR/fda:$VGBIO_SRC_DIR:$PWJ_SANDBOX_DIR
